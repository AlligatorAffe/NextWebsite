...
//Add item to database
  ...
  const addItem = async (e: SyntheticEvent) => {
    e.preventDefault();
    //if (newArticle.articleId !== "" && newArticle.textAuthor !== "" && newArticle.title !== "") {
      //setArticleData([...articleData, newArticle]);
      await addDoc(collection(db,'newArticle'),{
        userImage: "C:\Users\Alfre\NextWebsite\app\randomShit\katt.jpg",
  ...
  <input
    ...
    onChange={(e) => setNewArticle({...newArticle,textAuthor: e.target.value})}
  />
  ...
  <textarea
    ...
    onChange={(e) => setNewArticle({...newArticle,textBody: e.target.value})}
  ></textarea>
